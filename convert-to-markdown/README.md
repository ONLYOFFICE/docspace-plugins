# Markdown Converter - ONLYOFFICE Apps Plugin

Convert DOCX, HTML and TXT files to Markdown format directly in ONLYOFFICE Apps with a single click.
...
1. Navigate to a folder in ONLYOFFICE Apps
