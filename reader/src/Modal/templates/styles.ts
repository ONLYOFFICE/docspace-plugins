...
@media (min-width: 769px) {
  #spread-container { max-width: 700px; }
}
@media (min-width: 1025px) {
  #spread-container { max-width: 800px; }
}
@media (min-width: 1440px) {
  #spread-container { max-width: 900px; }
}
...
h1,h2,h3,h4 { line-height: 1.3; margin-top: 1.2em; }
p { margin: .5em 0; }
...
@media (max-width: 389px) {
  ...
  h1 { font-size: 1.4em; } h2 { font-size: 1.25em; } h3 { font-size: 1.1em; } h4 { font-size: 1em; }
  #reader-footer { flex: 0 0 48px; min-height: 48px; max-height: 48px; gap: 8px; }
  .nav-btn { width: 32px; height: 32px; font-size: 16px; }
  #nav-info-wrap { min-width: 90px; }
  #nav-label { font-size: 10px; }
  #nav-progress { width: 60px; }
  td, th { padding: 3px 4px; font-size: 0.8em; }
}
...
@media (min-width: 390px) and (max-width: 480px) {
  ...
  #reader-footer { flex: 0 0 48px; min-height: 48px; max-height: 48px; gap: 12px; }
  .nav-btn { width: 36px; height: 36px; font-size: 18px; }
  #nav-info-wrap { min-width: 100px; }
  #nav-label { font-size: 11px; }
  #nav-progress { width: 70px; }
  td, th { padding: 4px 6px; font-size: 0.85em; }
}

@media (min-width: 481px) and (max-width: 768px) {
  body { font-size: 16px; line-height: 1.65; }
  .page-panel { padding: 24px; }
  #reader-footer { flex: 0 0 44px; min-height: 44px; max-height: 44px; gap: 14px; }
  .nav-btn { width: 32px; height: 32px; font-size: 17px; }
  #nav-info-wrap { min-width: 110px; }
